    ...
    build:
      ...
      entries:
        ...
        Elytra2:
          ...
          prefix: <empty>
        Creature:
          flag_check: <player.flag[temp.cc.character.race].equals[Anthromorph]||false>
          prefix: <empty>
    clothing:
      can_scroll_down: true
      entries:
  ...
  data:
    race:
      ...
      Tone:
        ...
        entries:
          1:
            check_tag: <list[Fae|Human|Anthromorph].contains[<player.flag[temp.cc.character.race]>]>
          2:
            check_tag: <list[Fae|Human|Anthromorph].contains[<player.flag[temp.cc.character.race]>]>
          3:
            check_tag: <list[Fae|Human|Anthromorph].contains[<player.flag[temp.cc.character.race]>]>
      ...
      Eyes:
        ...
        entries:
          ...
          4:
            check_tag: <list[Fae|Human|Anthromorph].contains[<player.flag[temp.cc.character.race]>]>
          5:
            check_tag: <list[Fae|Human|Elytrian|Anthromorph].contains[<player.flag[temp.cc.character.race]>]>
          6:
            check_tag: <list[Fae|Human|Elytrian|Anthromorph].contains[<player.flag[temp.cc.character.race]>]>
          7:
            check_tag: <list[Fae|Human|Elytrian|Anthromorph].contains[<player.flag[temp.cc.character.race]>]>
    ...
    build:
      ...
      Creature:
        location: <[mini_spot].below[0.7]>
        select_script: cc_creature_select
        accept_script: cc_creature_select
        entries:
          Red:
            check_tag: true
          Purple:
  ...
  script:
    ...
    - choose <[race]>:
      ...
      - case Anthromorph:
        ...
        - flag <player> temp.cc.display.wings:!
        - flag <player> temp.cc.character.wings:!
        - flag <player> temp.cc.display.creature:cat
        - flag <player> temp.cc.character.creature:cat
        - flag <player> temp.cc.display.elytra1:!
        - flag <player> temp.cc.character.elytra1:!
        - flag <player> temp.cc.display.elytra2:!
        - flag <player> temp.cc.character.elytra2:!
...
cc_creature_select:
  ...
  data:
    creatures:
      black_cat: cat <&lc><&dq>variant<&dq>:<&dq>all_black<&dq><&rc>
      white_cat: cat <&lc><&dq>variant<&dq>:<&dq>white<&dq><&rc>
      asian_cat: cat <&lc><&dq>variant<&dq>:<&dq>siamese<&dq><&rc>
      ginger_cat: cat <&lc><&dq>variant<&dq>:<&dq>red<&dq><&rc>
      wolf: wolf
      bat: bat
      horse: horse
  script:
    - define menu_data <script[cc_open_mini_menu].data_key[data.<[top_menu]>.<[submenu]>]>
    - define creature <player.flag[temp.cc.mini_menu_options].get[<[selection]>]>
    - flag player temp.cc.creature:<[creature]>
    - flag player temp.cc.creature.display:<[creature]>
    - run clothing_external_set def:bottom|<[bottom]>
...
cc_height_select:
  ...
  script:
    ...
    - flag player temp.cc.character.height:<script.data_key[data.height_map.<[height]>]>
