capabilities_data:
  ...
  capability:
    lumberjack_harvest:
      ...
      harvests:
        oak_*:
          material_given: lumberjack_oak_wood
          quantity_given: 1
          capability_gained: 0.001
          capability_needed: 1
        birch_*:
          material_given: lumberjack_birch_wood
          quantity_given: 1
          seconds_needed: 5
          capability_gained: 0.001
          capability_needed: 100
        spruce_*:
          material_given: lumberjack_spruce_wood
          quantity_given: 1
          seconds_needed: 5
          capability_gained: 0.001
          capability_needed: 200
        jungle_*:
          material_given: lumberjack_jungle_wood
          quantity_given: 1
          capability_gained: 0.001
          capability_needed: 300
        acacia_*:
          material_given: lumberjack_acacia_wood
          quantity_given: 1
          capability_gained: 0.001
          capability_needed: 400
        dark_oak_*:
          material_given: lumberjack_dark_oak_wood
          quantity_given: 1
          capability_gained: 0.001
        ...
        stone:
          ...
          items:
            ...
            mining_stone_pickaxe:
              material_cost:
                blacksmith_stone_sheet: 4
                woodwork_oak_tool_handle: 1
            ...
            blacksmith_stone_greatsword:
              material_cost:
                blacksmith_stone_sheet: 10
                woodwork_oak_tool_handle: 4
        ...
        oak_planks:
          items:
            ...
            oak_stairs:
              ...
              rep_gained: 0.1
              needs_downshift: false
            woodwork_oak_tool_handle:
              material_cost:
                woodwork_stripped_oak_wood: 2
              capability_needed: 10
              rep_gained: 0.1
              needs_downshift: false
            oak_trapdoor:
            ...
            fantasyfurniture_nordicstool:
              material_cost:
                lumberjack_oak_planks: 6
                blacksmith_stone_nails: 4
              capability_needed: 79
              rep_gained: 0.1
              needs_downshift: false
            tailor_wood_sewing_needle:
              material_cost:
                lumberjack_oak_planks: 1
              capability_needed: 80
              rep_gained: 0.1
              needs_downshift: false
...
profession_generic_callback:
  ...
  script:
    ...
    - if <util.random_chance[10]>:
      - inventory adjust slot:<player.held_item_slot> durability:<player.item_in_hand.durability.add[1]>
...
profession_crafting_menu_open:
  ...
  script:
    ...
    - if !<server.flag[profession_data.capability_tables.<[capability]>.<[material]>].exists>:
      ...
      - stop
    - if !<player.has_flag[character.schematics.<[capability]>]>:
      - narrate "<&c>You lack the knowledge of any recipes with this."
      - stop
    - foreach <player.flag[character.schematics.<[capability]>]> key:capNeeded as:item:
      ...
      - foreach <[craftCost]> key:material as:quantity:
        - define lore "<[lore].include[<&e>- <[quantity]> <item[<[material]>].display>]>"
...
profession_interact_inhand_production:
  ...
  script:
    ...
    - if <player.flag[character.capabilities.<[capability_used]>]||0> < <script[capabilities_data].data_key[capability.<[capability]>.crafts.<[material]>.capability_needed]>:
      - narrate "<&c>You lack the capability to use this."
      - stop
