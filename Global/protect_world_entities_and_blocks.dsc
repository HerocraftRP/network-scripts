protect_world_entities_and_blocks:
  ...
  script:
    ...
    - foreach <[chunks]> as:chunk:
      - foreach <[chunk].cuboid.blocks[cauldron|days_in_the_middle_ages*|anvil|magistuarmory_pavise|fantasyfurniture_decorations*|*_shulker_box|fantasyfurniture_*_lockbox|chest|*_chest|*_dresser|FANTASYFURNITURE_*WARDROBE_BOTTOM|FANTASYFURNITURE_*WARDROBE_TOP|FANTASYFURNITURE_*DRAWER|FANTASYFURNITURE_*DESK_LEFT|hopper|TCONSTRUCT_*]> as:block:
